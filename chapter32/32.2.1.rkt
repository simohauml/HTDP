...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 32.2.1) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor mixed-fraction #t #t none #t ((lib "draw.rkt" "teachpack" "htdp")) #t)))
(define MC 3)
