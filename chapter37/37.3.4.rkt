...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 37.3.4) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; letter-left : integer
;; a state variable that counts how many letters the player doesn't know yet
(define letter-left 0)
...
(define (hangman)
  (begin
    ...
    (set! letter-left (length chosen-word))))
