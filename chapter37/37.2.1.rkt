...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 37.2.1) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; make-status-word : empty word list with same lenght of original word
(define (make-status-word w)
  (build-list (length w) (lambda (x) '_)))
