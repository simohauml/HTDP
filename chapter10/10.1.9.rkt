...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 10.1.9) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
(require htdp/sound)
...
(define (one-amount n singular-form plural-form)
  (cond
    ...
    [(<= n 20) (list n plural-form)]
    [(= 0 (modulo n 10)) (list n plural-form)]
    [else (list (* 10 (quotient n 10)) (modulo n 10) plural-form)]))
